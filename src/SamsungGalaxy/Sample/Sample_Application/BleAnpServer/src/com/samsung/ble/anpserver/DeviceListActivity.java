...
public class DeviceListActivity extends Activity {
    ...
    private ANPServerService mService = null;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
            case ANPServerService.GATT_DEVICE_FOUND_MSG:
                Bundle data = msg.getData();
                final BluetoothDevice device = data.getParcelable(BluetoothDevice.EXTRA_DEVICE);
                final int rssi = data.getInt(ANPServerService.EXTRA_RSSI);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onService = new ServiceConnection() {
            public void onServiceConnected(ComponentName className, IBinder rawBinder) {
                mService = ((ANPServerService.LocalBinder) rawBinder).getService();
                if (mService != null) {
        ...
        startService(new Intent(this, ANPServerService.class));
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (mService.mBluetoothGattServer.getConnectionState(device) == mService.mBluetoothGattServer.STATE_CONNECTED) {
